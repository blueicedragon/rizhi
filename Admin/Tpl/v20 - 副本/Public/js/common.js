$(function(){
    ...
    leftMenuTitle.each(function(i){
        ...
        if ($(this).hasClass('i_on')) {
            $(this).next().show();
            jiantou.attr('xlink:href','#i_icon-xiajiantou');
        } else {
            jiantou.attr('xlink:href','#i_icon-youjiantou');
        }
    });
    ...
    leftMenuTitle.on('click',function(){
        ...
        //$(this).siblings('div').find('.i_w50').find('svg').find('use').attr('xlink:href','#i_icon-youjiantou');
        ...
        if(is_show == 'block'){
            $(this).find('.i_w50').find('svg').find('use').attr('xlink:href','#i_icon-xiajiantou');
        }else{
            $(this).find('.i_w50').find('svg').find('use').attr('xlink:href','#i_icon-youjiantou');
        }
    ...
    $('.i_top_left_nav').hover(function(){
        ...
        $(this).find('a.i_nav_first').find('svg').find('use').attr('xlink:href','#i_icon-jiantoushang2');
        $(this).find('.i_sub_menu_box').show();
    },function(){
        $(this).find('a.i_nav_first').removeClass('i_on');
        $(this).find('a.i_nav_first').find('svg').find('use').attr('xlink:href','#i_icon-arrowDown');
