	...
	<div id="i_contents" class="i_nicescroll">
		...
		<div class="i_column g-margin clearfix">
			<ol class="breadcrumb">
				...
				<li><a href="javascript:;">渠道管理</a></li>
		...
		<div class="i_current_column g-margin">
			...
			<span class="i_bold">渠道详情</span>

		</div>
		<!-- end 当前栏目 -->


		<div class="i_single_page">

            <span class="i_titles2"><?php echo ($show["title"]); ?></span>
            <!-- end title -->

			<ul class="i_txt_list">
				<li>
					<span class="i_txt_list_l">日志标题</span>
					<span class="i_txt_list_r"><?php echo ($show["title"]); ?></span>
				</li>
				<li>
					<span class="i_txt_list_l">所属项目</span>
					<span class="i_txt_list_r"><?php echo ($show["pname"]); ?></span>
				</li>
				<li>
					<span class="i_txt_list_l">所属人员</span>
					<span class="i_txt_list_r"><?php echo ($show["cname"]); ?></span>
				</li>
				<li>
					<span class="i_txt_list_l">日志内容</span>
					<span class="i_txt_list_r"><?php echo ($show["content"]); ?></span>
				</li>
				<li>
					<span class="i_txt_list_l">添加时间</span>
					<span class="i_txt_list_r"><?php echo (date("Y-m-d",$show["regtime"])); ?></span>
				</li>
			</ul>
			<!-- end 信息列表 -->
...
<script type="text/javascript" src="./Tpl/Public/scripts/ajaxfileupload.js"></script>
<script type="text/javascript" src="./Tpl/Public/scripts/upload.js"></script>

<script charset="utf-8" src="./Tpl/Public/kindedito/kindeditor.js"></script>
<script charset="utf-8" src="./Tpl/Public/kindedito/lang/zh_CN.js"></script>
...
//类型改成JS加层样式来做
$(document).ready(function(){
		$('.L_switching li').click(function(){
			$('.L_switching li').removeClass('on');
			$(this).addClass('on');
			$('.add_info').hide();
			$('.add_info').eq($('.L_switching li').index($(this))).show();
		})
});
Calendar.setup({
	weekNumbers: true,
