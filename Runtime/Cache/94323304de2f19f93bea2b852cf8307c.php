...
<div id="i_menu1">
	...
	<div id="i_contents" class="i_nicescroll">
        ...
        <div class="i_current_column g-margin">
            ...
            <span class="i_bold">添加用户</span>

        </div>
        <!-- end 当前栏目 -->
		
		<form action="./index.php?m=<?php echo (MODULE_NAME); ?>&a=insert" method="post">
            <dl class="pop-form default-form clearfix">
                <dd>
                    <span class="l">姓名</span>
                    <div class="r">
                        <input type="text" class="form-control max" name="name" id="name">
                    </div>
                </dd>
                <dd>
                    <span class="l">用户名</span>
                    <span class="r">
                        <input type="text" class="form-control max" name="username" id="username">
                    </span>
                </dd>
                <dd>
                    <span class="l">密码</span>
                    <span class="r">
                        <input type="text" class="form-control max" name="password" id="password">
                    </span>
                </dd>
                <dd>
                    <span class="l">&nbsp;</span>
