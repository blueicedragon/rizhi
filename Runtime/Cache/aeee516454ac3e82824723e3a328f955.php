...
<title>项目管理 - <?php echo (L("Public_Admin")); ?> - <?php echo (L("Public_name")); ?></title>
...
<div id="i_menu1">
	...
	<div id="i_contents" class="i_nicescroll">
		...
		<div class="search-form-inline bg-color clearfix">
			...
			<label>项目名称</label>
			<input type="text" class="form-control" placeholder="请输入项目名称" autocomplete="off" value="<?php echo ($map["title"]); ?>" name="title">
		...
		<?php if(($list) != ""): ?><form id="cAll_form" action="./index.php?m=<?php echo (MODULE_NAME); ?>&a=del" method="post">
                <table class="table g-margin">
					...
					<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
							<td><?php echo ($k); ?></td>
							<td><a href="./index.php?m=<?php echo (MODULE_NAME); ?>&a=detail&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
